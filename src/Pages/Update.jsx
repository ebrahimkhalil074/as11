...
const Update = () => {
  ...
  // const [ title,category,short_dis,long_dis,image,time,blog_email,date,] =loader ||{}
  console.log(loader);
...
.then(data =>{
  ...
  <h1  className="mr-36  font-['Dancing'] font-extrabold text-3xl ">Update Your Awesome Blog</h1>
  </div>
  ...
  <option>Photography & Nature</option>
    ...
    <button
    onClick={()=>handelUpdate(loader._id)}
